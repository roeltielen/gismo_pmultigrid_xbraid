...
The file starts with a general description of *p*-multigrid methods, after which both the 'pMultigridexampla' and 'xbraid_heatEquation_example' are discussed in more detail.
